...
# images = ["Relative_color_array_2000_2005.tif", "Relative_color_array_2005_2010.tif",
#           "Relative_color_array_2010_2015.tif","Relative_color_array_2015_2020.tif"]
images = ["New_color_Relative_Difference_color_array_2000_2005.tif", "New_color_Relative_Difference_color_array_2005_2010.tif",
          "New_color_Relative_Difference_color_array_2010_2015.tif", "New_color_Relative_Difference_color_array_2015_2020.tif"]
...
titles = ["a. Global Forest Edge Dynamics (Relative Difference, 2000 - 2005)", 
          "b. Global Forest Edge Dynamics (Relative Difference, 2005 - 2010)", 
          "c. Global Forest Edge Dynamics (Relative Difference, 2010 - 2015)",
          "d. Global Forest Edge Dynamics (Relative Difference, 2015 - 2020)"]
...
for idx, image in enumerate(images):
    ...
    if idx == 0: 
        mask = np.all(data == data[0,0,:], axis=-1)
        data[mask, 3] = 0
    ...
    axx = ax.inset_axes([0.1,0.17,0.23,0.23])
    ...
    axx.text(1,-0.05, '+20%', transform=axx.transAxes, fontsize = 5)
    axx.text(-0.15,0.78, '+20%', transform=axx.transAxes, fontsize = 5,rotation= 90)
    axx.text(-0.3,-0.3, '-20%', transform=axx.transAxes, fontsize = 5,rotation= 45)

out = '/scratch/fji7/Forest_edge_mapping_2024_11_14/2_exported_figures/Figure S4_Forest edge dynamics_relative difference'
